...
program.fs - созданный файл с кодом программы на языке F#. В данной папке необходимо создать файл с расширением .aoi для дальнейшего написания кода.
